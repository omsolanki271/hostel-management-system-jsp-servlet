...
<%
    request.setAttribute("activeMenu", "newComplaints");
%>
...
<%
    ...
    if (request.getAttribute("complaints") == null) {
        response.sendRedirect(request.getContextPath() + "/admin/new-complaints");
        return;
    }
...
<head>
    <meta charset="UTF-8">
    <title>New Complaints | Admin Panel</title>
...
<body>
    ...
    <div class="admin-content">
        ...
        <div class="top-action-bar">
            <h2 class="page-title">New Complaints</h2>
        ...
        <div class="table-box">
            <table>
                ...
                <tbody>
                    ...
                    %>
                        <tr>
                            <td colspan="6" style="text-align: center; color: #777;">No new complaints found.</td>
                        </tr>
                    <%
                        } else {
                            int count = 1;
