...
@WebServlet("/admin/new-complaints")
public class AdminNewComplaintsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String selectQuery = "SELECT id, ComplainNumber, complaintType, complaintStatus, registrationDate " +
                                 "FROM complaints WHERE complaintStatus IS NULL OR complaintStatus = '' " +
                                 "ORDER BY id DESC";
        ...
        request.getRequestDispatcher("/admin/new-complaints.jsp").forward(request, response);
    }
