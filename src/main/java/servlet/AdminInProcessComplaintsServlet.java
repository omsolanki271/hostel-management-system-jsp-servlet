...
@WebServlet("/admin/inprocess-complaints")
public class AdminInProcessComplaintsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/admin/inprocess-complaints.jsp").forward(request, response);
    }
