...
@WebServlet("/admin/rejected-leaves")
public class AdminRejectedLeavesServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/admin/rejected-leaves.jsp").forward(request, response);
    }
}
