...
@WebServlet("/admin/closed-complaints")
public class AdminClosedComplaintsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/admin/closed-complaints.jsp").forward(request, response);
    }
