...
@WebServlet("/admin/search-complaint")
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (searchVal != null && !searchVal.trim().isEmpty()) {
            ...
            try {
                ...
                String searchQuery = "SELECT id, ComplainNumber, complaintType, complaintStatus, registrationDate " +
                                     "FROM complaints WHERE ComplainNumber LIKE ? OR complaintType LIKE ? OR complaintStatus LIKE ? OR complaintDetails LIKE ? " +
                                     "ORDER BY id DESC";
        ...
        request.getRequestDispatcher("/admin/search-complaint.jsp").forward(request, response);
    }
